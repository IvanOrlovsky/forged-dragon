			...
			<div className="flex flex-col lg:flex-row lg:items-center ">
				...
				<div className="lg:w-3/5 dark:text-light-text text-dark-text font-medium">
					<p className="text-lg leading-relaxed mb-4">
						...
						представляем наш опыт и знания в области художественной
						ковки, которые мы развиваем уже более 12 лет. В нашей
						мастерской мы уделяем особое внимание каждому этапу
						создания уникальных изделий, чтобы каждое произведение
						не только соответствовало высоким стандартам качества,
						но и отражало наш творческий подход.
					</p>
					<p className="text-lg leading-relaxed mb-4">
					...
					<p className="text-lg leading-relaxed">
						Мы всегда рады новым вызовам и проектам, поэтому если у
						вас есть идея или желание создать что-то уникальное, не
